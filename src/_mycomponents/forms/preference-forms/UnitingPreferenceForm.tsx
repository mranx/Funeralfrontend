...
const formSchema = z.object({
  ...
  viewingMusic: z.boolean().optional().default(false), // Optional with default
  fillerMusicPreService: z.boolean().optional().default(false), // Optional with default
  placingOfSymbols: z.boolean().optional().default(false), // Optional with default
});
