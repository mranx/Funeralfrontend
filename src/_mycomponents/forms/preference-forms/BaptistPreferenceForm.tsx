...
import SelectField, { SelectionType } from "@/_mycomponents/common/SelectField"; // Adjust the import based on your folder structure
...
export default function BaptistPreferenceForm() {
  ...
  const onSubmit = (data: FormData) => {
    // Mapping the selected options to the preferences object
